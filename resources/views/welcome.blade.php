...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{('public/frontend/images/ipple-touch-icon-72-precomposed.png')}}">
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="left-sidebar">
                    ...
                    <div class="products_products"><!--products_products-->
                        <h2>Thương Hiệu</h2>
