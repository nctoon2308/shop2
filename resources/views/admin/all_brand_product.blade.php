                    ...
                    @foreach($all_brand_product as $key => $cate_pro)
                        <tr>
                            ...
                            <td>
                                ...
                                <?php
                                }else if($cate_pro->brand_status==1){
                                ?>
                            ...
                            <td>
                                ...
                                <a href="{{URL::to('/edit-brand-product/'.$cate_pro->brand_id)}}" class="styling-edit active" ui-toggle-class="">
                                    <i class="fa fa-pencil-square-o text-success text-active"></i></a>
                                <a onclick="return confirm('Bạn có muốn xoá không?')" href="{{URL::to('/delete-brand-product/'.$cate_pro->brand_id)}}" class="styling-edit active" ui-toggle-class="">
